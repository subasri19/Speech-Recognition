...
public class SpeechRecognitionPlugin implements MethodCallHandler, RecognitionListener {
    ...
    private SpeechRecognitionPlugin(Activity activity, MethodChannel channel) {
        ...
        speech = SpeechRecognizer.createSpeechRecognizer(activity.getApplicationContext(),ComponentName.unflattenFromString("com.google.android.googlequicksearchbox/com.google.android.voicesearch.serviceapi.GoogleRecognitionService"));
        ...
        // recognizerIntent.putExtra(RecognizerIntent.EXTRA_SPEECH_INPUT_COMPLETE_SILENCE_LENGTH_MILLIS, 200000); 
    }
